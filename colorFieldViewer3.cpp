...
void drawFrontSquare( float xOffset, float yOffset,float zOffset, float alpha ) {
  glBegin(GL_POLYGON);
  glColor4f( 0.0, 1.0, 1.0, alpha );     glVertex3f(  0.5+xOffset, -0.5+yOffset, -0.5+zOffset );      // P1 is red
  glColor4f( 1.0, 0.0, 1.0, alpha );     glVertex3f(  0.5+xOffset,  0.5+yOffset, -0.5+zOffset );      // P2 is green
  glColor4f( 0.0, 1.0, 0.0, alpha );     glVertex3f( -0.5+xOffset,  0.5+yOffset, -0.5+zOffset );      // P3 is blue
  glColor4f( 1.0, 1.0, 1.0, alpha );     glVertex3f( -0.5+xOffset, -0.5+yOffset, -0.5+zOffset );      // P4 is purple
  glEnd();
}

void drawBackSquare( float xOffset, float yOffset,float zOffset, float alpha ) {
  glBegin(GL_POLYGON);
  glColor4f( 1.0, 0.0, 0.0, alpha );     glVertex3f(  0.5+xOffset, -0.5+yOffset, 0.5+zOffset );
  glColor4f( 1.0, 1.0, 0.0, alpha );     glVertex3f(  0.5+xOffset,  0.5+yOffset, 0.5+zOffset );
  glColor4f( 1.0, 0.0, 1.0, alpha );     glVertex3f( -0.5+xOffset,  0.5+yOffset, 0.5+zOffset );
  glColor4f( 1.0, 1.0, 1.0, alpha );     glVertex3f( -0.5+xOffset, -0.5+yOffset, 0.5+zOffset );
  glEnd();
}
...
void drawBottomSquare( float xOffset, float yOffset,float zOffset, float alpha ) {
  glBegin(GL_POLYGON);
  glColor4f( 1.0, 1.0, 1.0, alpha );     glVertex3f(  0.5+xOffset, -0.5+yOffset, -0.5+zOffset );
  glColor4f( 0.0, 0.0, 1.0, alpha );     glVertex3f(  0.5+xOffset, -0.5+yOffset,  0.5+zOffset );
  glColor4f( 1.0, 0.0, 1.0, alpha );     glVertex3f( -0.5+xOffset, -0.5+yOffset,  0.5+zOffset );
  glColor4f( 1.0, 0.0, 0.0, alpha );     glVertex3f( -0.5+xOffset, -0.5+yOffset, -0.5+zOffset );
  glEnd();
}
...
void drawTopSquare( float xOffset, float yOffset,float zOffset, float alpha ) {
  ...
  glColor4f( 1.0, 1.0, 0.0, alpha );     glVertex3f(  0.5+xOffset,  0.5+yOffset,  0.5+zOffset );
  glColor4f( 0.0, 1.0, 0.0, alpha );     glVertex3f(  0.5+xOffset,  0.5+yOffset, -0.5+zOffset );
  glColor4f( 1.0, 1.0, 1.0, alpha );     glVertex3f( -0.5+xOffset,  0.5+yOffset, -0.5+zOffset );
  glColor4f( 1.0, 0.0, 1.0, alpha );     glVertex3f( -0.5+xOffset,  0.5+yOffset,  0.5+zOffset );
  glEnd();
}
...
void drawLeftSquare( float xOffset, float yOffset,float zOffset, float alpha ) {
  glBegin(GL_POLYGON);
  glColor4f( 1.0, 0.0, 1.0, alpha );     glVertex3f( -0.5+xOffset, -0.5+yOffset,  0.5+zOffset );
  glColor4f( 0.0, 1.0, 1.0, alpha );     glVertex3f( -0.5+xOffset,  0.5+yOffset,  0.5+zOffset );
  glColor4f( 0.0, 0.0, 1.0, alpha );     glVertex3f( -0.5+xOffset,  0.5+yOffset, -0.5+zOffset );
  glColor4f( 1.0, 0.0, 1.0, alpha );     glVertex3f( -0.5+xOffset, -0.5+yOffset, -0.5+zOffset );
  glEnd();  
}
...
{   
  ...
  // Other Transformations
    ...
    for (int i = 0; i < xDim; i ++) {
      for (int j = 0; j < yDim; j++) {
        for (int k = 0; k < zDim; k++) {
          if (isAlive(i,j,k) ) drawCube(i-xDim/2,j-yDim/2,k-zRes/2, 0.15);
        }
      }
    }
 }
